...
for exp in exp_lists:
    ...
    with open("/home/ubuntu/"+data_dir_tx0+"/"+"{name_tx0}-result.json".format(name_tx0=name_tx0)) as f:
    ...
    df_f1= pd.read_csv("/home/ubuntu/"+data_dir_tx0+"/"+"{name_tx0}-ss.csv".format(name_tx0=name_tx0), names=columns)
